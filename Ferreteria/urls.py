...
from .views import Index, Productos, Prod_1 , Admin1,Registrar,delete_Producto, Modificar,Pagar ,pago,procesar_pago,Webpay,agregar_producto,eliminar_producto,limpiar_carrito,restar_producto
